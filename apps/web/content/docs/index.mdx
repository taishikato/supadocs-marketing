...
3. **GitHub Actions workflow** runs `supabase/embeddings-generator`, chunks the changed files, generates embeddings, and writes directly to Supabase pgvector tables.
